...
"""
Hashabele - string number and tuple so basically immutable elements that are unique
...
"""
METHODS
 - keys() - returns us all the keys
    returns like dict_keys(['name','age'])
 - values() - returns us all the values
    returns Values like dict_items([(key,value),(key,value),(key,value)])..
    ...like this

"""

"""
Iteration - either through keys (.keys()) -(default )
                           values (.values())
                           key value (.items())
